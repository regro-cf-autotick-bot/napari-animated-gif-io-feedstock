...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-animated-gif-io-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15266&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-animated-gif-io-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-animated-gif-io` can be installed with:

```
conda install napari-animated-gif-io
```

It is possible to list all of the versions of `napari-animated-gif-io` available on your platform with:
